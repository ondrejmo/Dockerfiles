...
All images should be up-to-date and automaticly builded on [My Docker Hub](https://hub.docker.com/u/ondrejmo), except for images in ***UNMAINTAINED.d**, those I haven't finished yet or I simply don't use/maintain them.
